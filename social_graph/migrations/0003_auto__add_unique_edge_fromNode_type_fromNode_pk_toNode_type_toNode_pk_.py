...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Edge', fields ['fromNode_type', 'fromNode_pk', 'toNode_type', 'toNode_pk', 'type', 'site']
        db.create_unique(u'social_graph_edge', ['fromNode_type_id', 'fromNode_pk', 'toNode_type_id', 'toNode_pk', 'type_id', 'site_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Edge', fields ['fromNode_type', 'fromNode_pk', 'toNode_type', 'toNode_pk', 'type', 'site']
        db.delete_unique(u'social_graph_edge', ['fromNode_type_id', 'fromNode_pk', 'toNode_type_id', 'toNode_pk', 'type_id', 'site_id'])
    ...
    models = {
        ...
        u'social_graph.edge': {
            'Meta': {'ordering': "['-time']", 'unique_together': "(['fromNode_type', 'fromNode_pk', 'toNode_type', 'toNode_pk', 'type', 'site'],)", 'object_name': 'Edge'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'edges'", 'to': u"orm['sites.Site']"}),
        ...
        u'social_graph.edgecount': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'edge_counters'", 'to': u"orm['sites.Site']"}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social_graph.EdgeType']"})
        },
